...
describe('[Challenge] Backdoor', function () {
    ...
    it('Exploit', async function () {
        ...
        const checkTokenBalance = async (address, name) => {
            ...
            console.log(`toooooken balance ofu ${name}`, ethers.utils.formatEther(tokenBal));
        }

        await checkTokenBalance(attacker.address, "attacker");

        //attacku contractu
        const AttackModuleFactory = await ethers.getContractFactory("AttackBackddoor", attacker);
        ...
        console.log("Deployed attacking module at this address right here bud ->", attackModule.address);

        //malicious ABI call to setupToken()
        ...
        // run exploit in just one transaction after the contract is deployed zz
